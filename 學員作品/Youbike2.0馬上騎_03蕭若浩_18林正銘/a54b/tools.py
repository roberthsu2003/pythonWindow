...
class CustomMessagebox(Dialog):    
    ...
    def body(self, master):
        ...
        start_point = self.site.lat+0.00025,self.site.lng+0.00025
        end_point = start_point[0], start_point[1]-0.0005
        down_point = end_point[0]-0.0005,end_point[1]
        left_point = down_point[0], down_point[1] + 0.0005
        up_point = left_point[0]+0.0005, left_point[1]
